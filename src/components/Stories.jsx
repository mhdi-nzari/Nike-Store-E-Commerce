          ...
          <Splide options={splideOptions}>
            {news.map((val, index) => (
              <SplideSlide key={index} className="mb-0.5">
                <div className="relative grid items-center gap-5 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200">
                  ...
                  <div className="flex items-center justify-between w-full px-4 ">
                    <div className="flex items-center gap-1  ">
                      <HeartIcon className="icon-style text-red-500 w-5 h-50" />
                  ...
                  <div className="flex items-center justify-items-center px-4 w-full">
                    <a
                      href={val.url}
                      className="w-full bg-slate-900 bg-gradient-to-b from-slate-900  to-black shadow-md shadow-black text-center text-slate-100 py-1.5"
                      target={"_blank"}
                      role={"button"}
                    >
                      {val.btn}
